...
// TODO: sort this out into a separate file for each function
public static unsafe partial class Win32
{
    ...
    [LibraryImport("user32.dll")]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static partial BOOL SetMenu(
        HWND hWnd,
        HMENU hMenu
    );
    ...
    public static partial INT_PTR DialogBoxParam(
        HINSTANCE hInstance,
    ...
    public static partial HRSRC FindResource(
        HMODULE hModule,
        LPCWSTR lpName,
        LPCWSTR lpType
    );
    ...
    [LibraryImport("kernel32.dll")]
    public static partial HGLOBAL LoadResource(
        HMODULE hModule,
        HRSRC hResInfo
    );
    ...
    [LibraryImport("user32.dll")]
    [return: MarshalAs(UnmanagedType.Bool)]
    public static partial BOOL PrintWindow(
        HWND hwnd,
        HDC hdcBlt,
        UINT nFlags
    );
    ...
    [LibraryImport("user32.dll")]
    public static partial HMENU GetMenu(
        HWND hWnd
    );
